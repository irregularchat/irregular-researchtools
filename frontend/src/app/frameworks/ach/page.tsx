/**
 * Public ACH Analysis Landing Page
 * 
...
import { Plus, Search, Target, Clock, FileText, Trash2, Brain } from 'lucide-react'
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg">
              Analysis of Competing Hypotheses with evidence evaluation
            </p>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <Link href={`/frameworks/ach/create?resume=${session.id}`}>
                        ...
                        {session.data && (
                          <div className="grid grid-cols-2 gap-4 text-xs">
                            <div className="text-center p-2 bg-blue-50 dark:bg-blue-900/20 rounded">
                              <p className="text-blue-700 dark:text-blue-300 font-medium">Hypotheses</p>
                              <p className="text-blue-800 dark:text-blue-200">
                                {session.data.hypotheses?.length || 0}
                              </p>
                            </div>
                            <div className="text-center p-2 bg-orange-50 dark:bg-orange-900/20 rounded">
                              <p className="text-orange-700 dark:text-orange-300 font-medium">Evidence</p>
        ...
        <Card className="border-dashed border-2 border-gray-300 dark:border-gray-600">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="text-gray-900 dark:text-gray-100">
              Start Your ACH Analysis
            </CardTitle>
            <CardDescription>
              Systematically evaluate competing hypotheses using evidence-based scoring
            </CardDescription>
          </CardHeader>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
              What is ACH Analysis?
            </h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
              Analysis of Competing Hypotheses (ACH) is a structured methodology for 
              evaluating multiple hypotheses using evidence. Each piece of evidence is 
              scored against each hypothesis, helping analysts identify which explanations 
              are most consistent with the available information and avoid confirmation bias.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400 text-sm space-y-1">
              <li>• Intelligence analysis and threat assessment</li>
              <li>• Root cause analysis and incident investigation</li>
              <li>• Strategic decision making with uncertainty</li>
              <li>• Research hypothesis testing</li>
              <li>• Complex problem solving with multiple explanations</li>
            </ul>
          </div>
        </div>
      </div>
